...
class PlatformProductizationTest(unittest.TestCase):
    ...
    def test_production_release_is_main_sha_versioned_and_has_hard_publish_gates(self) -> None:
        ...
        self.assertIn("PyPI did not expose both distributions after $max_attempts attempts.", workflow)
        self.assertIn("PyPI readback is not yet indexable; retrying in 10 seconds", workflow)
        ...
        self.assertIn('DRAFT_ID="$(ep_create_draft_release)"', workflow)
