...
class StandaloneServerFoundationTest(unittest.TestCase):
    ...
    def test_schema_58_upgrade_installs_immutable_forge_exchange_audit(self) -> None:
        ...
        with sqlite3.connect(database) as connection:
            for trigger in (
                ...
                "ep_forge_exchange_audit_immutable_delete",
            ):
    ...
    def test_ep_database_panel_is_framed_and_maintenance_selection_recovers_safely(self) -> None:
        ...
        self.assertIn('class="configuration-central-database__export"', panel)
        self.assertIn('href="/api/central-data/export"', panel)
        self.assertNotIn('dashboard-action--download" href="/api/central-data/export"', panel)
